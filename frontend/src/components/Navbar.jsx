        ...
        `}</style>
              ...
              {greeting},{' '}
                ...
                <div style={{ display:'flex', alignItems:'center', gap:16, animation:'navIn .4s .2s ease both' }}>
                    ...
                    <Link to="/upload"
                          style={{ background:'#c9a84c', color:'#0a0800', padding:'8px 18px', borderRadius:8, fontFamily:'Syne,sans-serif', fontSize:13, fontWeight:700, letterSpacing:.5, textDecoration:'none', transition:'transform .2s,box-shadow .2s', display:'flex', alignItems:'center', gap:6 }}
                    ...
                    {user && (
                        <div style={{ position:'relative' }}>
                            ...
                            <div id="profile-dropdown" style={{ display:'none', position:'absolute', top:'calc(100% + 12px)', right:0, background:dropBg, border:'1px solid ' + navBorder, borderRadius:12, padding:8, minWidth:210, boxShadow:'0 16px 48px rgba(0,0,0,0.4)', zIndex:99999 }}>
                                ...
                                <button className="drop-btn" style={{ color:t.text }}
                                        onClick={() => { navigate('/friends'); closeDropdown() }}
                                        onMouseEnter={e => e.currentTarget.style.background = t.dark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)'}
                                        onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                                ><span>🔗</span> Conexiones</button>
                                ...
                                <div style={{ borderTop:'1px solid ' + navBorder, marginTop:4, paddingTop:4 }}>
                                    <button className="drop-btn" style={{ color:'#c9a84c' }}
                                            onClick={() => { closeDropdown(); setShowShareCard(true) }}
                                            onMouseEnter={e => e.currentTarget.style.background = 'rgba(201,168,76,0.08)'}
                                            onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                                    ><span>✦</span> Compartir perfil</button>
